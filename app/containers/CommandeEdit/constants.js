...
export default assign(commandeConst, annulerConst, { INIT_COMMANDE, AJOUTER_OFFRE, SUPPRIMER_OFFRE, AUGMENTER_OFFRE, DIMINUER_OFFRE, LOAD_COMMANDE, SET_DISTRIBUTION, CHANGE_DISTRIBUTION, MODIFIE_TOTAUX });
