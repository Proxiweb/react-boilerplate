          ...
          <div className="col-md-4">
            {tarifications &&
              ...
              <TextField
                ...
                fullWidth
                value={round(tarifications[index].prix * 0.11, 2)}
              />}
          </div>
...
class offreForm extends Component {
  ...
  render() {
    const { handleSubmit, pending, pristine, handleToggeState, valeurs, quantiteUnite } = this.props;
            ...
            <div className="row">
              ...
              <div className="col-xs-6">
                <div className="row">
                  ...
                  <div className="col-xs-4" style={{ paddingTop: "40px", color: "gray" }}>
