    ...
    return (
      <div className={`row ${styles.offre}`}>
        <div className="col-md-8">
          <OffreDetails key={idx} offre={offre} qteCommande={0} typeProduit={typeProduit} />
        </div>
        ...
        <div className="col-md-2">
          <IconButton onClick={() => handleStore(offre)} tooltip="Archiver" tooltipPosition="top-center">
