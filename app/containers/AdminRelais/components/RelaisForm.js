...
class RelaisForm extends Component { // eslint-disable-line react/prefer-stateless-function
  static propTypes = {
      ...
      <form onSubmit={handleSubmit} style={{ padding: '1rem' }}>
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-12">
                <Field cols="6" inputStyle={{ textTransform: 'uppercase' }} floatingLabelText="Nom du relais" name="nom" fullWidth component={TextField} ref={(node) => (this.nom = node)} />
              </div>
              <div className="col-md-6">
