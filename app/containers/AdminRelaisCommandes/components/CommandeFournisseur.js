...
class CommandeFournisseur extends Component {
  ...
  handleSendMessageFournisseur = () => {
    const { commandeContenus, fournisseur, commandeId, produits, offres } = this.props;
  ...
  render() {
    const { fournisseur, produits, commandeContenus, commandeId, offres } = this.props;
            ...
            <div className="row center-md">
              {fournisseur.telPortable &&
                <div className="col-md-4">
                  <FlatButton icon={<MessageIcon />} onClick={this.handleSendMessageFournisseur} fullWidth />
                </div>}
              <div className="col-md-4">
                <RaisedButton
                  secondary
