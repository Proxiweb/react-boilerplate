...
const modifierCommandeContenu = generateConstants(
  'app/Commande',
  'modifier_commande_contenu',
);
...
const deleteOffreConst = generateConstants('app/Commande', 'delete_offre');
...
const saveUtilisateurConst = generateConstants(
  'app/Commande',
  'save_utilisateur',
);
...
const saveFournisseursConst = generateConstants(
  'app/Commande',
  'save_fournisseur',
);
...
const payeCommandeUtilisateurConst = generateConstants(
  'app/CommandeEdit',
  'paye_commande_utilisateur',
);
